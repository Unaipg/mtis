...
public class HotelServiceSOAPSkeleton implements org.example.www.HotelService.HotelService_PortType, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    static {
        ...
        _oper = new org.apache.axis.description.OperationDesc("getHotels", _params, new javax.xml.namespace.QName("", "out"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://www.example.org/HotelService/", "Hotels"));
        _oper.setElementQName(new javax.xml.namespace.QName("http://www.example.org/HotelService/", "getHotels"));
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.example.org/HotelService/", "BookDates"), org.example.www.HotelService.BookDates.class, false, false), 
        };
        _oper = new org.apache.axis.description.OperationDesc("getRooms", _params, new javax.xml.namespace.QName("", "out"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://www.example.org/HotelService/", "Rooms"));
        _oper.setElementQName(new javax.xml.namespace.QName("http://www.example.org/HotelService/", "getRooms"));
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "in"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.example.org/HotelService/", "Booking"), org.example.www.HotelService.Booking.class, false, false), 
        };
        _oper = new org.apache.axis.description.OperationDesc("makeBooking", _params, new javax.xml.namespace.QName("", "out"));
        _oper.setReturnType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        _oper.setElementQName(new javax.xml.namespace.QName("http://www.example.org/HotelService/", "makeBooking"));
    ...
    {
        org.example.www.HotelService.Hotel[] ret = impl.getHotels(in);
        return ret;
    }
