 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static BookActivity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BookActivity object =
                new BookActivity();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"bookActivity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BookActivity)org.example.www.activitiesservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
